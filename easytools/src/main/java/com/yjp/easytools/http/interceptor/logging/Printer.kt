...
internal open class Printer private constructor() {
    companion object {
        ...
        fun printJsonRequest(
            ...
            val requestBody =
                LINE_SEPARATOR + BODY_TAG + LINE_SEPARATOR + bodyToString(
                    request
                )
            ...
            logLines(
                builder.type,
                tag,
                getRequest(request, builder.level),
                builder.logger,
                true
            )
        ...
        fun printJsonResponse(
            ...
            val responseBody =
                LINE_SEPARATOR + BODY_TAG + LINE_SEPARATOR + getJsonString(
                    bodyString
                )
        ...
        private fun getResponse(
            ...
            message =
                ...
                ) "" else if (loggableHeader) HEADERS_TAG + LINE_SEPARATOR +
